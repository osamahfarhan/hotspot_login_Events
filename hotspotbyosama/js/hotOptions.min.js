...
function p(a){a.innerHTML=q();setInterval(function(){a.innerHTML=q()},1E3)}function q(){var a=new Date,b=("0"+a.getSeconds()).slice(-2),g=("0"+a.getMinutes()).slice(-2);a=("0"+a.getHours()).slice(-2);var c="صباحاً";12<a&&(a=("0"+(a-12)).slice(-2),c="مساءً");return"  الساعة الان "+a+":"+g+":"+b+" "+c}
function startFitText(){var a=document.querySelectorAll("[data-fit-text]"),b;a=$jscomp.makeIterator(a);for(b=a.next();!b.done;b=a.next())b=b.value,fitText(b,.215)}
